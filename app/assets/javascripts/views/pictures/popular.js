Picturito.Views.Popular = Backbone.CompositeView.extend({
  ...
  initialize: function() {
    ...
    if (this.nextPage > this.totalPages) {
      this.nextPage = "#/popular/" + this.totalPages;
    } else {
      this.nextPage = "#/popular/" + this.nextPage;
    }

    if (this.prevPage < 2) {
      this.prevPage = "#/popular";
    } else {
      this.prevPage = "#/popular/" + this.prevPage;
    }
  },
  ...
  goToPage: function(event) {
    ...
    if (page === 1) {
      Backbone.history.navigate("#/popular/1");
    } else {
      Backbone.history.navigate("#/popular/" + page);
    }
  },
